...
static bool parse(SpHttp *p, Message *msg, const uint8_t *in, size_t inlen,
                  ssize_t speed) {
  ...
  while (body > 0 || !sp_http_is_done(p)) {
    ...
    if (body > 0) {
      ...
      if (p->type == SP_HTTP_REQUEST) {
        strncat(msg->as.request.method, (char *)buf + p->as.request.method.off,
                p->as.request.method.len);
        strncat(msg->as.request.uri, (char *)buf + p->as.request.uri.off,
        ...
        strncat(msg->fields[msg->field_count].name,
                (char *)buf + p->as.field.name.off, p->as.field.name.len);
        strncat(msg->fields[msg->field_count].value,
                (char *)buf + p->as.field.value.off, p->as.field.value.len);
        msg->field_count++;
...
static void test_request(ssize_t speed) {
  SpHttp p;
...
static void test_request_capture(ssize_t speed) {
  SpHttp p;
...
static void test_chunked_request(ssize_t speed) {
  SpHttp p;
  sp_http_init_request(&p, false);
...
static void test_chunked_request_capture(ssize_t speed) {
  SpHttp p;
  sp_http_init_request(&p, true);
...
static void test_response(ssize_t speed) {
  SpHttp p;
...
static void test_chunked_response(ssize_t speed) {
  SpHttp p;
  sp_http_init_response(&p, false);
...
static void test_invalid_header(void) {
  static const uint8_t request[] = "GET /some/path HTTP/1.1\r\n"
                                   "Header\r\n"
                                   "\r\n";
...
static void test_limit_method_size(void) {
  static const uint8_t request[] =
...
static void test_exceed_method_size(void) {
  static const uint8_t request[] =
...
static void test_limit_name_size(void) {
  static const uint8_t request[] =
      "GET /some/path HTTP/1.1\r\n"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX: value\r\n"
      "\r\n";
...
static void test_exceed_name_size(void) {
  static const uint8_t request[] =
      "GET /some/path HTTP/1.1\r\n"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX: value\r\n"
      "\r\n";
...
static void test_limit_value_size(void) {
  static const uint8_t request[] =
      "GET /some/path HTTP/1.1\r\n"
      "Name:"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
static void test_exceed_value_size(void) {
  static const uint8_t request[] =
      "GET /some/path HTTP/1.1\r\n"
      "Name:"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
static void test_increase_value_size(void) {
  static const uint8_t request[] =
      "GET /some/path HTTP/1.1\r\n"
      "Name:"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
static void test_cc_max_stale(void) {
  SpCacheControl cc;
  ssize_t n;
...
static void test_cc_private(void) {
  SpCacheControl cc;
  ssize_t n;
...
static void test_cc_no_cache(void) {
  SpCacheControl cc;
  ssize_t n;
...
static void test_cc_group(void) {
  SpCacheControl cc;
  ssize_t n;
  ...
  mu_assert_int_eq(cc.type,
                   SP_CACHE_MAX_AGE | SP_CACHE_NO_CACHE | SP_CACHE_NO_STORE);
}

static void test_cc_group_semi(void) {
  SpCacheControl cc;
  ssize_t n;
...
static void test_cc_all(void) {
  const char buf[] = "public,"
                     "private,"
                     "private=\"stuff\","
                     "no-cache,"
                     "no-cache=\"thing\","
  ...
  mu_assert_int_eq(cc.type & SP_CACHE_MUST_REVALIDATE,
                   SP_CACHE_MUST_REVALIDATE);
  mu_assert_int_eq(cc.type & SP_CACHE_PROXY_REVALIDATE,
                   SP_CACHE_PROXY_REVALIDATE);
...
static void test_cc_all_semi(void) {
  const char buf[] = "public;"
                     "private;"
                     "private=\"stuff\";"
                     "no-cache;"
