...
static void test_splice_offset(void) {
  int values[] = {1, 2, 3};
  int *vec = NULL;
...
static void test_splice_remove_offset(void) {
  int first[] = {1, 2, 3, 4};
  int second[] = {10, 20, 30};
  int *vec = NULL;
...
static void test_splice_remove_end(void) {
  int first[] = {1, 2, 3, 4};
  int second[] = {10, 20, 30};
  int *vec = NULL;
...
static int cmp(const int *key, const int *val) { return *key - *val; }
