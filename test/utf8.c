...
static void test_double_bytes(void) {
  SpUtf8 u = SP_UTF8_MAKE();
  ssize_t n;
...
static void test_triple_bytes(void) {
  SpUtf8 u = SP_UTF8_MAKE();
  ssize_t n;
...
static void test_quad_bytes(void) {
  SpUtf8 u = SP_UTF8_MAKE();
  ssize_t n;
...
static void test_invalid_codepoints(void) {
  SpUtf8 u = SP_UTF8_MAKE();
  ssize_t n;
...
static void test_uri_decode(void) {
  ...
  SpUtf8 u = SP_UTF8_MAKE();
  ssize_t n =
      sp_utf8_decode(&u, in, sizeof(in) - 1, SP_UTF8_URI | SP_UTF8_SPACE_PLUS);
  mu_assert_int_eq(n, (ssize_t)(sizeof(cmp) - 1));
  mu_assert_str_eq(u.buf, cmp);
  sp_utf8_final(&u);
}
...
static void test_uri_encode(void) {
  ...
  SpUtf8 u = SP_UTF8_MAKE();
  ssize_t n =
      sp_utf8_encode(&u, in, sizeof(in) - 1, SP_UTF8_URI | SP_UTF8_SPACE_PLUS);
  mu_assert_int_eq(n, (ssize_t)(sizeof(cmp) - 1));
  mu_assert_str_eq(u.buf, cmp);
  sp_utf8_final(&u);
}

static void test_uri_encode_ascii(void) {
  char in[] = " !\"#$%&'()*+,-./"
              "0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`"
              "abcdefghijklmnopqrstuvwxyz{|}~";
  char cmp[] = "%20!%22#$%25&'()*+,-./"
               "0123456789:;%3C=%3E?@ABCDEFGHIJKLMNOPQRSTUVWXYZ%5B%5C%5D%5E_%"
...
static void test_uri_encode_ascii_space_plus(void) {
  char in[] = " !\"#$%&'()*+,-./"
              "0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`"
              "abcdefghijklmnopqrstuvwxyz{|}~";
  char cmp[] = "+!%22#$%25&'()*+,-./"
...
static void test_uri_encode_ascii_comp(void) {
  char in[] = " !\"#$%&'()*+,-./"
              "0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`"
              "abcdefghijklmnopqrstuvwxyz{|}~";
  char cmp[] = "%20!%22%23%24%25%26'()*%2B%2C-.%2F0123456789%3A%3B%3C%3D%3E%3F%"
