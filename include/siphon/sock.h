 ...
 */
SP_EXPORT int sp_listen(const char *uri, int stype, const SpSockConfig *cfg,
                        struct sockaddr_storage *s);

SP_EXPORT int sp_dial(const char *uri, int stype, const SpSockConfig *cfg,
                      struct sockaddr_storage *s);

SP_EXPORT int sp_sock_config(int fd, const SpSockConfig *cfg);

SP_EXPORT int sp_sock_nonblock(int fd, bool on);

SP_EXPORT int sp_sock_cloexec(int fd, bool on);

SP_EXPORT int sp_sock_type(int fd);
