...
__attribute__((unused)) static inline void sp_list_init(SpList *list) {
  list->link[0] = list->link[1] = list;
}

__attribute__((unused)) static inline void sp_list_entry_clear(SpList *entry) {
  entry->link[0] = NULL;
  entry->link[1] = NULL;
}
...
__attribute__((unused)) static inline SpList *sp_list_first(const SpList *list,
                                                            SpOrder dir) {
...
__attribute__((unused)) static inline void sp_list_del(SpList *entry) {
...
__attribute__((unused)) static inline SpList *sp_list_pop(SpList *list,
                                                          SpOrder dir) {
  SpList *entry = sp_list_first(list, dir);
  if (entry != NULL) {
    sp_list_del(entry);
...
__attribute__((unused)) static inline void sp_list_copy_head(SpList *dst,
                                                             SpList *src) {
...
__attribute__((unused)) static inline void sp_list_replace(SpList *dst,
                                                           SpList *src) {
  sp_list_copy_head(dst, src);
  sp_list_init(src);
}

__attribute__((unused)) static inline void sp_list_swap(SpList *a, SpList *b) {
  SpList tmp;
...
__attribute__((unused)) static inline void sp_list_insert(SpList *entry,
                                                          SpList *before) {
...
#define sp_list_each(list, var, dir)                                           \
  for (SpList * sp_sym(n) = (var = (list)->link[(dir)], var->link[(dir)]);     \
       var != (list); var = sp_sym(n), sp_sym(n) = sp_sym(n)->link[(dir)])
